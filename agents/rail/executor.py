...
class RailProviderExecutor(AgentExecutor):
    """Adapter between the A2A server framework and RailProviderAgent."""

    def __init__(self, agent: RailProviderAgent):
        self.agent = agent
    ...
    async def execute(self, context: RequestContext, event_queue: EventQueue) -> None:
        ...
        try:
            ...
            logger.error(f"RailProviderAgent error: {e}")
